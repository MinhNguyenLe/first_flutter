...
class VeritableSearchScreen extends StatefulWidget {
  const VeritableSearchScreen({Key? key}) : super(key: key);

  @override
  State<VeritableSearchScreen> createState() => _SearchScreenState();
}

class _SearchScreenState extends State<VeritableSearchScreen> {
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      searchSuggestionsTiem("Cây ăn quả"),
                      searchSuggestionsTiem("Cây dịch vụ"),
                    ],
                  ),
                  const SizedBox(
                    height: 16,
                  ...
                  Row(
                    children: [
                      searchSuggestionsTiem("Cây lâu năm"),
                      searchSuggestionsTiem("Giống cây trồng"),
                    ],
                  ),
                ],
              ),
